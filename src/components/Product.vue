...
li(
  ...
  class="flex item-center space-x-6 border border-gray-200 p-6 bg-white shadow"
)
  img(
    :src="product.image"
    alt="product.name"
  ...
  div(class="space-y-2 flex-auto")
    h3(class="text-gray-900") {{ product.name }}
    p(class="font-extrabold") {{ formatCurrency(product.price) }}
    p {{ product.availability }} en Existencia
