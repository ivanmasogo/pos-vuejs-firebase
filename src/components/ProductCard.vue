...
div(class="rounded bg-white shadow relative")
  ...
  div(class="p-3 space-y-2")
    h3(class="text-xl font-black text-gray-500") {{ product.name }}
    p(class="text-gray-500") Disponibles: {{ product.availability }}
    p(class="text-2xl font-extrabold text-gray-900") {{ formatCurrency(product.price) }}
